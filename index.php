...
<head>
    ...
    <link rel="icon" href="#">
    <title>Beranda Barabutter</title>
...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/bara.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Your favorite croffle is ready to deliver</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Pilih outlet</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order makanan</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Makanan diantar</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Menu Favorit Customer</h2>
                    <p class="lead">Order croffle in barabutter to save your day!</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Pilih outlet</h3>
                                    <p>Pilih outlet Barabutter terdekat dari rumah kamu!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Pilih menu andalan kamu</h3>
                                <p>Gak cuma croffle, kopi dan toast juga bisa kamu order di Barabutter</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Tunggu sebentar, makanan segera datang</p>
                            </div>
                        </div>
                    </div>
                </div>
