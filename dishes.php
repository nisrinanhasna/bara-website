                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                       <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Beranda <span class="sr-only"></span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Outlet <span class="sr-only">(current)</span></a> </li>
        ...
        <div class="page-wrapper">
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pilih menu favorit Kamu</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order dan bayar</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/baru.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>TOTAL</p>
                                        <h3 class="value"><strong><?php echo "Rp. ".$item_total."RB"; ?></strong></h3>
                                        <!-- <p>Free Delivery!</p> -->
                                        <?php
                                        if($item_total==0){
                                        ?>
